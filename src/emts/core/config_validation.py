...
from emts.core.models import OrderedRawModel, RawConfig, ValidatedConfig
...
def validate(raw_config: RawConfig) -> ValidatedConfig:
    ...
    # point in time
    _validate_routes(raw_config)
    _validate_workflows(raw_config)
    _validate_models(raw_config)
    return _validate_graph_and_add_order(raw_config)


def _validate_routes(raw_config: RawConfig) -> None:
...
def _validate_workflows(raw_config: RawConfig) -> None:
...
def _validate_models(raw_config: RawConfig) -> None:
    """Validate all models.
...
def _validate_graph_and_add_order(raw_config: RawConfig) -> ValidatedConfig:
    ...
    """
    topological_order = _validate_graph_and_calculate_order(raw_config)
...
def _validate_graph_and_calculate_order(raw_config: RawConfig) -> dict[str, int]:
    ...
    edges = [
        (route.input_model_name, route.output_model_name) for route in raw_config.routes
    ]
