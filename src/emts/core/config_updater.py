...
from emts.core.model_derivation import ModelDerivationError, derive_models
from emts.core.models import PersistedConfig, RawConfig
...
class ConfigUpdater:
    ...
    async def update_config(self):
        ...
        if self._current_config is None:
            ...
            inconsistent_version = ConfigUpdaterError(
    ...
    async def resolve_and_persist(self, input_config_path: Path) -> bool:
        ...
        Raises:
            ConfigUpdaterError: If the new config fails validation and no previous
    ...
    async def _resolve_has_config_changed(
        ...
        try:
            ...
            if not (
                ...
                log.critical(msg)
                raise ConfigUpdaterError(msg) from error
