...
- <a id="properties/claim_ttl_seconds"></a>**`claim_ttl_seconds`** *(integer)*: Seconds after which a claimed but unprocessed AEMPack is considered stale and may be reclaimed by another instance. Must be chosen well above the worst-case processing time. Default: `300`.
